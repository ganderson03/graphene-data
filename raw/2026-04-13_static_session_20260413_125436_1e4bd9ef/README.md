...
**Target:** `tests\java\target\escape-tests-1.0-SNAPSHOT.jar;tests\java\target\classes:com.escape.tests.cases.Case246SerializationRoundtripSafe04:execute`
**Language:** java
**Analyzer Version:** 1.0.0-static
**Session ID:** 55b5a302-a6be-4b3e-a4b4-fef649a74fd6
**Generated:** 2026-04-13 12:54:36
...
✅ No execution errors were detected in this run.
