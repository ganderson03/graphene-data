...
**Target:** `tests\java\target\escape-tests-1.0-SNAPSHOT.jar;tests\java\target\classes:com.escape.tests.cases.Case086RouteSubscription:execute`
**Language:** java
**Analyzer Version:** 1.0.0-static
**Session ID:** d8bfaab9-93fc-4357-824e-254c82e16c9a
